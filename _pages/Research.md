...
<details>
      <summary><b>abstract</b></summary>
      Scholars have long argued that international integration can be sustained by providing sufficient government compensation to workers harmed by globalization. We argue that the success of such compensation schemes also depends on the bureaucracies tasked with implementing them. Specifically, bureaucratic delays in delivering benefits to trade-affected workers can undermine trust in the government's capacity to mitigate the adverse effects of globalization, thereby weakening public support for international integration. We test this theory using the U.S. Trade Adjustment Assistance (TAA) program. Leveraging the quasi-random assignment of TAA petitions to individual bureaucrats, we estimate the effect of bureaucrat-driven delays in processing petitions on public attitudes in affected communities. Our empirical results support the theory and indicate that the effects are stronger where information about TAA delays is more likely to reach citizens. We also find that such delays increase voters' support for politicians who promote economic nationalism, highlighting the broader political consequences of bureaucratic performance.
</details>  
<p/>    
